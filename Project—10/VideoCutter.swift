...
public class VideoCutter: NSObject {
     ...
     */
    public func cropVideoWithUrl(videoUrl url: NSURL, stratTime: CGFloat, duration: CGFloat, completion: ((videoPath: NSURL?, error: NSError?) -> Void)?) {
        ...
        dispatch_async(dispatch_get_global_queue(priority, 0)) {
            ...
            if let exportSession = exportSession as AVAssetExportSession? {
                ...
                let start = CMTimeMakeWithSeconds(Float64(stratTime), 600)
